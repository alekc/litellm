...
# Maximum characters of a single INFO-or-higher log line written to stdout; longer lines
# keep their head and tail and drop the middle. DEBUG records are never truncated.
# Set to 0 to disable truncation.
